          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pb-4">
                  {filteredPlayers.map(p => {
                       ...
                       // Determine knowledge level: If assigned scout region matches, show more info?
                       // Simplified: Always show for now, but mark "Scouted" if matches assignment.
                       const isScouted = playerClub.scouting.assignments.some(a =>
                           (a.region === 'Global' || a.region === 'Europe') // Simplified matching
                       );
