...
// --- NAME DATABASES ---
const EN_FIRST = ["James", "John", "Robert", "Michael", "William", "David", "Richard", "Joseph", "Thomas", "Charles", "Harry", "Jack", "Oliver", "George", "Noah"];
const EN_LAST = ["Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez", "Wilson", "Evans", "Taylor", "Moore"];

const ES_FIRST = ["Jose", "Carlos", "Juan", "Luis", "Pedro", "Miguel", "Pablo", "Sergio", "Fernando", "Jorge", "Alejandro", "Diego", "Alvaro", "Iker", "Unai", "Gavi"];
const ES_LAST = ["Garcia", "Rodriguez", "Gonzalez", "Fernandez", "Lopez", "Martinez", "Sanchez", "Perez", "Gomez", "Martin", "Ruiz", "Hernandez", "Diaz", "Moreno", "Torres"];

const DE_FIRST = ["Thomas", "Manuel", "Lukas", "Felix", "Julian", "Leon", "Joshua", "Kai", "Florian", "Jamal", "Serge", "Leroy", "Niklas", "Timo", "Mats", "Max"];
const DE_LAST = ["Müller", "Schmidt", "Schneider", "Fischer", "Weber", "Meyer", "Wagner", "Becker", "Schulz", "Hoffmann", "Koch", "Bauer", "Richter", "Klein", "Wolf"];

const FR_FIRST = ["Kylian", "Antoine", "Olivier", "Hugo", "Raphael", "Paul", "N'Golo", "Kingsley", "Ousmane", "Eduardo", "William", "Theo", "Lucas", "Adrien", "Jules"];
const FR_LAST = ["Martin", "Bernard", "Thomas", "Petit", "Robert", "Richard", "Durand", "Dubois", "Moreau", "Laurent", "Simon", "Michel", "Lefebvre", "Leroy", "Roux"];

const IT_FIRST = ["Gianluigi", "Alessandro", "Leonardo", "Federico", "Lorenzo", "Nicolo", "Marco", "Francesco", "Giorgio", "Andrea", "Matteo", "Davide", "Ciro", "Giacomo", "Sandro"];
const IT_LAST = ["Rossi", "Russo", "Ferrari", "Esposito", "Bianchi", "Romano", "Colombo", "Ricci", "Marino", "Greco", "Bruno", "Gallo", "Conti", "De Luca", "Costa"];
